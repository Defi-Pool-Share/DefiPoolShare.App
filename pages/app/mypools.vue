      ...
      <div class="defi-Pools-wrapper">
        <div class="defi-Pools-section">
          ...
          <div class="app-paragraphe">
            <p>
              Below, you'll find a list of the Uniswap pool NFTs in your
              possession. When you contribute liquidity to a trading pair on
              Uniswap, you are given an NFT that signifies your stake in that
              specific pool. This NFT can be loaned out on Defi Pool Share. To
              determine a suitable borrowing price for prospective buyers, it's
              important to know the percentage of the initial pool that you own,
              as this will give you an idea of your LP NFT's value.
            </p>
          </div>
        ...
        <div class="defi-Pools-section">
          ...
          <div class="app-paragraphe">
            <p>
              This list displays the NFT LP positions you have offered for
              borrowing or those that are currently being borrowed. You can
              track their status and, when the loan period concludes, retrieve
              your NFT LP. After the loan has been completed, you may choose to
              offer your liquidity for borrowing once more, for a specified
              duration. This allows you to efficiently manage your assets and
              share them with others in the marketplace.
            </p>
          </div>
        ...
        <div class="defi-Pools-section">
          ...
          <div class="app-paragraphe">
            <p>
              With the DeFi Pool Share Protocol marketplace, you can borrow NFT
              LP positions from others. During the loan period, you're able to
              claim the fees generated by the pool at any time using the smart
              contract. It's a simple way to utilize borrowed assets and benefit
              from their rewards. However, once the loan duration ends, you'll
              lose access to the LP position, and the NFT will return to the
              original owner. This system offers a straightforward and
              accessible way to engage with DeFi opportunities.
            </p>
          </div>
